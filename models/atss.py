...
class ATSSConfig:
    ...
    def __init__(self):
        ...
        # ------------------------ training cfg ---------------------- #
        self.train_image_short_size = (1436, 1472, 1504, 1536, 1568, 1600)
        # self.train_image_short_size = (768,)
        self.train_image_max_size = 2300
        ...
        # ------------------------ testing cfg ----------------------- #
        self.test_image_short_size = 1800
        self.test_image_max_size = 2700
        self.test_max_boxes_per_image = 100
        self.test_vis_threshold = 0.2
